...
getProfessores().then(data => {
  ...
  data.forEach(aluno => {
    ...
    editar.addEventListener('click', () => editarAluno(aluno.id));
    ...
    excluir.addEventListener('click', () => excluirAluno(aluno.id));
